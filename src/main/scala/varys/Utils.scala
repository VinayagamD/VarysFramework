...
import java.util.{Collections, Locale, Random}
  ...
  private def findLocalIpAddress(): String = {
    ...
    if (defaultIpOverride != null) {
      ...
      if (address.isLoopbackAddress) {
        ...
        val activeNetworks = NetworkInterface.getNetworkInterfaces.asScala.toSeq
        val reOrderedNetworkIFs = activeNetworks.reverse
